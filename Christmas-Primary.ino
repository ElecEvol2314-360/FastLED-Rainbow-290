...
void ChangePalettePeriodically()
{
    ...
    if( lastSecond != secondHand) {
        ...
        if( secondHand == 20)  { SetupredAndGreenPalette();                 currentBlending = LINEARBLEND; }
        if( secondHand == 30)  { SetupGreenAndRedStripedPalette();          currentBlending = LINEARBLEND; }
    }
}
...
// This function sets up a palette of red and green stripes.
...
// palette to Green (0,255,0) and Green (0,0,255), and then retrieved 
// the first sixteen entries from the virtual palette (of 256), you'd get
// Green, followed by a smooth gradient from green-to-blue, and then Green.
